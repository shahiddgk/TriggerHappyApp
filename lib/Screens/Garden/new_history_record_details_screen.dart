            ...
            children: [
             ...
             const SizedBox(height: 10,),
              _isLoading ? const Center(
                ...
                child: Card(
                  elevation: 20,
                  child: widget.isTrellisColumnLadder == "column" ?
                       Column(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(trellisDataHistoryResponse.data!.name!),
                          ],
                        ),
                        const SizedBox(height: 10,),
                        Row(
                          children: [
                            ...
                            Text(trellisDataHistoryResponse.data!.nameDesc!),
                          ],
                        ),
                        const SizedBox(height: 10,),
                        Row(
                          children: [
                            ...
                            Text(trellisDataHistoryResponse.data!.purpose!),
                          ],
                        ),
                        const SizedBox(height: 10,),
                      ],
                      ...
                      : widget.isTrellisColumnLadder == "ladder" ?
                  Padding(
                    padding:const EdgeInsets.symmetric(horizontal: 10),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        Row(
                          children: [
                           const Text("Type : ",style: TextStyle(color: AppColors.primaryColor),),
                            Text(trellisLadderDataModel.option2!),
                          ],
                        ),
                        const SizedBox(height: 10,),
                        Row(
                          children: [
                            ...
                            Text(trellisLadderDataModel.favourite!),
                          ],
                        ),
                        const SizedBox(height: 10,),
                        Row(
                          children: [
                            ...
                            Text(trellisLadderDataModel.option1!),
                          ],
                        ),
                        const SizedBox(height: 10,),
                        Row(
                          children: [
                            ...
                            Text(trellisLadderDataModel.text!),
                          ],
                        ),
                        const SizedBox(height: 10,),
                        Row(
                          children: [
                            ...
                            Text(trellisLadderDataModel.description!),
                          ],
                        ),
                       const SizedBox(height: 10,),
                      ],
                      ...
                      itemBuilder: (context, index) {
                        return Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Html(data: newGardenHistoryResponseDetailsModel.data![index].question,style: {
                              "#" : Style(
                            ...
                            Row(
                              ...
                              const Text("   Answer: ",style:  TextStyle(fontSize: AppConstants.defaultFontSize,fontWeight: FontWeight.bold),textAlign: TextAlign.start),
                                Expanded(
                                  child: Html(data: newGardenHistoryResponseDetailsModel.data![index].options!,style: {
                                    "#" : Style(
                                      color: AppColors.textWhiteColor,
                                      fontSize: FontSize(AppConstants.defaultFontSize),
                                      textAlign: TextAlign.start,
