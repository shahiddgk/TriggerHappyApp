...
import 'package:flutter_quiz_app/Screens/Chat/ChatScreen/widgets/msg_card.dart';
                ...
                //  select gallery multiple images
                 IconButton(
                  ...
                  final List<XFile> images = await picker.pickMultiImage();
                    ...
                    await Apis.sendChatImage(widget.user,File(i.path),"1");
                ...
                //  camera button
                 IconButton(
                  ...
                  final XFile? image = await picker.pickImage(source: ImageSource.camera);
                    ...
                    Apis.sendChatImage(widget.user,File(image.path),"1");
                      setState(() => _isUploading=false,);
  ...
  Widget _appBar(){
    return InkWell(
      ...
      Column(
        ...
        children: [
          // user name
        Text(list.isNotEmpty?list[0].name:widget.user.senderName!,style: GoogleFonts.balooBhai2(
