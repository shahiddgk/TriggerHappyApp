...
// ignore_for_file: avoid_print, use_build_context_synchronously, depend_on_referenced_packages, unused_element, unused_field
...
class _TreeScreen1State extends State<TreeScreen1> with TickerProviderStateMixin{
  ...
  _getUserData() async {
    ...
    sharedPreferences.setInt("BadgeCount", 0);
    sharedPreferences.setInt("BadgeShareResponseCount", 0);
